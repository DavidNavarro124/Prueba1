  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="mostrar_contacto.php">Revisar Contactos</a></li>
      </ul>
...
$q = "SELECT * FROM contactos INNER JOIN alumnos ON contactos.matricula_alumno=alumnos.matricula ORDER by matricula_alumno ASC";
$rs = mysqli_query($enlace, $q);
echo "<table border = '3'> \n"; 
echo "<tr><td>Nombres</td><td>Primer Apellido</td><td>Segundo Apellido</td><td>Telefono de Casa</td><td>Telefono Celular</td><td>Email</td><td></td><td>Matricula Alumno</td><td>Nombre Alumno</td><td>Apellido Paterno Alumno</td><td>Apellido Materno Alumno</td></tr> \n"; 
while ($row = mysqli_fetch_row($rs)) {
		echo "<tr><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>$row[5]</td><td>$row[6]</td><td>...Informacion Alumno...</td><td>$row[7]</td><td>$row[8]</td><td>$row[9]</td><td>$row[10]</td></tr> \n";
